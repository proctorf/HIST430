...
You are to identify and critically analyze one of the more significant primary documents for your research paper. If your source base relies on a variety of smaller sources (say, newspaper articles), you should analyze multiple sources.
...
**Complete Draft for Peer Review Due:** {{ site.data.due_dates.source_analysis_1_draft }}  
**Final Draft Due:** {{ site.data.due_dates.source_analysis_1_final }} (via Canvas)
...
**Complete Draft for Peer Review Due:** {{ site.data.due_dates.source_analysis_2_draft }}  
**Final Draft Due:** {{ site.data.due_dates.source_analysis_2_final }} (via Canvas)
