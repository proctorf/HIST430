...
**Complete Draft Due:** {{ site.data.due_dates.historiography_draft }}  
**Final Draft Due:** {{ site.data.due_dates.historiography_final }} (via Canvas)
...
The historiography should be structured around arguments, debates, and/or approaches and not around individual authors. (If your historiography reads like an annotated bibliography in narrative form, you should consider restructuring it).
